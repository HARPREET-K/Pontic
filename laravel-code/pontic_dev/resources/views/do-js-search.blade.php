                ...
                <div class="pageContBox">
                    ...
                    <div class="profileDetailsSec">
                        <div class="profileRightBtnSec">
                            ...
                            <input type="button" value="Chat" class="btn" onclick="javascript:jqcc.cometchat.chatWith({{ $jobseeker->id }});"/>
                        </div> 
                        <div class="threeDotSec">
                            ...
                            <ul id="dropDown{{ $jobseeker->id  }}" class="dropdown-content">
                                <li>  <input type="button" value="Chat" class="btn" onclick="javascript:jqcc.cometchat.chatWith({{ $jobseeker->id }});"/></li>                         
                            </ul>
                        </div> 
                        <div class="nameSec">
                            <a  href="{{ secure_url('jsDetails/'.$jobseeker->id) }}">
