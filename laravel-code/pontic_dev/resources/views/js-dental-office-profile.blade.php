                ...
                <div class="formSec">
                    <div class="genInfoFormSec">
                        ...
                        <div class="detailFormSec row">
                            ...
                            <input type="button"  value="Chat" class="btn" onclick="javascript:jqcc.cometchat.chatWith({{ $officeInformation->user_id }});" style="float:right; width:110px;"/>
						  </div>
                            <div class="commonRow">
                            ...
                            <div class="jobListTableSec">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ url('/postDetails/'.$job->id) }}"> {{ date('M d, Y', $job->start_date)  }}</a></td>
                                        <td><a href="{{ url('/postDetails/'.$job->id) }}">{{ date('M d, Y', $job->end_date)  }}</a></td>
                                        <td><a href="{{ url('/postDetails/'.$job->id) }}">
