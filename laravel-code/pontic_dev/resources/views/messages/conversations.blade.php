    ...
    <div class="chat">
      <div class="chat-header clearfix">
        ...
        <div class="chat-about">
            @if(isset($users))
                <div class="chat-with">{{ $users->name }}</div>
            @else
        ...
        <ul id="talkMessages">
            ...
            @foreach($messages as $message)
               ...
               @endif<span class="message-data-name"> <!--<a href="#" class="talkDeleteMessage" data-message-id="{{$message->id}}" title="Delete Message"><i class="fa fa-close" style="margin-right: 3px;"></i></a>--></span>
                            <span class="message-data-time">{{$message->humans_time}} ago</span>
                        </div>
