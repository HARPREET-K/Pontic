...
<div id="mainBodyDiv" class="bodyContSec withOutTopMenu">
    ...
    <div class="doProfileFindWorker">
             ...
             <a href="{{ url('dentalOfficeDetails/'.$job->office_id) }}" >
                ...
                <div class="profileDetailsSec">
                    <div class="profileRightBtnSec">
                       <input type="button" value="Chat" class="btn" onclick="javascript:jqcc.cometchat.chatWith({{ $job->user_id }});"/>
                    </div>
                    <div class="threeDotSec">
                        ...
                        <ul id="dropDown{{ $job->id }}" class="dropdown-content">
                            <li> <input type="button" value="Chat" class="btn" onclick="javascript:jqcc.cometchat.chatWith({{ $job->user_id }});"/></li>                         
                        </ul>
                    </div>
                    <div class="nameSec">
                    ...
                    <div class="rowSec">                    
                        <div class="leftTextSec">Start Date</div>
                        <div class="rightTextSec">
                            {{ date('M d, Y', $job->start_date) }}
                        </div>
                         <div class="clear"></div>
                    </div>
                    <div class="rowSec">                    
                        <div class="leftTextSec">End Date</div>
                        <div class="rightTextSec">
                            {{ date('M d, Y', $job->end_date) }}
                        </div>
                         <div class="clear"></div>
                    </div>
                    <div class="rowSec">                    
        ...
        @else
        <div class="paginationDivSec">
            Please update your address before searching for jobs
        </div>
        @endif
                ...
                <div class="formRowSec">
                    <div class="input-field">                            
                        <select id="job_type" name="job_type">
                            ...
                            <option value="{{ $job_type->id }}" {{ (Request::get('job_type')==$job_type->id ? "selected":"") }}>{{ $job_type->name  }}</option>
                            @endforeach
                    ...
                    <div class="input-field">                            
                        <select id="job_position" name="job_position">
                            <option  selected value="">Any</option>
                            @foreach ($user_types as $user_type)
                            <option value="{{ $user_type->id }}" {{ (Request::get('job_position')==$user_type->id ? "selected":"") }}>{{ $user_type->user_type  }}</option>
                            @endforeach
                        </select>
