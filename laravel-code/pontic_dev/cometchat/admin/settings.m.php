								...
								<div class="form-group row">
									<div class="col-md-12">
							      	<label class="form-control-label">Avoid callbacks?:</label>
							      		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" type="radio" name="AVOIDCALLBACK" value="1" $avoidcby ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" type="radio" name="AVOIDCALLBACK" value="0" $avoidcbn></div><span style="padding-left:30px;">No</span></label></div>
									</div>
								</div>
