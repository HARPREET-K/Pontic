...
use AuthenticatesAndRegistersUsers,
    ...
    public function authenticated(Request $request, $user) {
        ...
        */
        ...
        if ($user->activated==0) {
            auth()->logout();
            return back()->with('warning', 'Your account is not activated yet. Please verify your E-mail to activate your account.(A varification E-mail is already sent to your E-mail Address.)');
        }
